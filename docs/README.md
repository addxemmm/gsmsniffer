...
| Guide | Scope / 范围 |
|---|---|
| [QUICKSTART](QUICKSTART.md) | Demo startup, authentication / 演示启动和鉴权 |
| [ARCHITECTURE](ARCHITECTURE.md) | Go control plane, process boundary / 架构与进程边界 |
| [API](API.md) | REST contract and examples / 接口契约 |
| [WEB_UI](WEB_UI.md) | Console operations / 控制台操作 |
| [DEPLOY](DEPLOY.md) | Secrets, containers, shielded prerequisites / 部署 |
